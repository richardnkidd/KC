  ...
  const handleRefresh = async () => {
    ...
    try {
      await Promise.all([
        ...
        mutate('/api/sun'),
        mutate('/api/traffic'),
        mutate((key) => typeof key === 'string' && key.startsWith('/api/rain-radar')),
      ]);
    ...
    <div className="relative">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-[#333333]/70 font-light hidden sm:block">
                  O'ahu real-time |  "Makapuu to Makaha"
                </p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative overflow-visible">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 min-h-0">
          ...
          <div className="tropical-card rain-radar-card animate-fade-in" style={{ animationDelay: '0.12s' }}>
            <RainRadarCard />
          </div>
          ...
          <div className="tropical-card traffic-card animate-fade-in" style={{ animationDelay: '0.35s' }}>
            <TrafficCard />
          </div>
